	...
	<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
		<div class="cart woocommerce-cart-form__contents">
			...
			?>
				...
				<!-- CART ITEM -->
				<div class="cart_item woocommerce-cart-form__cart-item bg-white flex flex-col md:flex-row md:items-center justify-between mb-5 <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<div class="flex items-center mb-5 md:mb-0">
						...
						<!-- TITLE -->
						<div class="cart_item_title mb-2 px-3 md:px-0">
							<?php
								if ( ! $product_permalink ) {
					...
					<!-- QTY PRICE DELETE -->
					<div class="flex items-center justify-between px-3 md:px-0 mb-3 md:mb-0">

						<!-- QTY -->
						<div class="cart_item_qty mr-0 md:mr-20" data-title="<?php esc_attr_e( 'Quantity', 'woocommerce' ); ?>">
							<?php
						...
						<!-- TRASH -->
						<div class="cart_item_trash md:px-5 md:py-8">
							<?php
			...
			<div class="cart_total cart-collaterals flex justify-end items-end mb-10 md:mb-32">
				<div class="mr-5">
					<?php _e('Итого', 'welbrix'); ?>:	
				</div>	
				<div class="price cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
...
<div class="cart_buttons flex flex-col md:flex-row md:justify-between md:items-center">
	<div class="btn_transparent relative uppercase py-5 mb-5 md:mb-0">
