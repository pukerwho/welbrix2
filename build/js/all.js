...
$(document).ready(function() {
	...
	//Добавляем active класс первым элементам
  $('.products_tab_heading:first-child').addClass('active');
  $('.products_tab_content:first').addClass('active');

  //Удаляем active класс по клику и добавляем на кликнутый
  $('.products_tab_heading').on('click', function(){
  	$('.products_tab_heading').removeClass('active');
  	$('.products_tab_content').removeClass('active');

  	$(this).addClass('active');
  	let dataProductTop = $(this).data('nav-top-products');
  	console.log(dataProductTop);
  	$('.products_tab_content[data-content-top-products="'+dataProductTop+'"]').addClass('active');
  });
});
